 ...
 * memberBoardListSize: 특정 회원 게시물 개수 조회 크기
 * adminBoardList: 관리자 권한의 게시물 조회
 * adminBoardSearch: 관리자 권한의 게시물 검색
 * adminBoardSearchSize: 관리자 권한의 게시물 검색 결과 개수 
 * todayBestList: 금일 인기글
 * weekBestList: 주간 인기글
 * monthBestList: 월간 인기글
 * yearBestList: 연간 인기글
 * 
 */
